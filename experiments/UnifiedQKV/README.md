# Experimental Fork: SP8192 + 3-Layer Recurrence + Parallel Residuals + Unified Q + Pick-First KV

This directory is a draft experiment forked from `2026-04-09_SP8192_3LayerRecur_ParResid_QK525_LegalTTT`.
The measured results below are inherited baseline notes and have **not** been re-run for this variant.
